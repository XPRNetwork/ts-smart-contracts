...
function FindSection(buf, id) {
   ...
   */
  export function GetSourceMapURL (buf) {
  ...
  export function RemoveSourceMapURL (buf) {
    buf = new Uint8Array(buf);
  ...
  export function SetSourceMapURL (buf, url) {
  ...
  export function SetSourceMapURLRelativeTo (buf, relativeURL) {
